package game.second_sem_work.shooter.net;
...
import game.second_sem_work.shooter.net.packets.ActionPacket;
import game.second_sem_work.shooter.net.packets.ClientPacket;
import game.second_sem_work.shooter.net.packets.DisconnectPacket;
